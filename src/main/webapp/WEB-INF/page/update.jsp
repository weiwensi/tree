    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
            <div><a class="navbar-brand" style="font-size:32px;" href="user.html">修改</a></div>
        </div>
      </div>
    </nav>
			  ...
			  <div class="panel-body">
				<form role="form">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="url"  value=${permission.url} placeholder="请输入许可URL">
				  </div>
				  <button id="saveBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 修改</button>
        ...
        <script type="text/javascript">
            ...
            $("#saveBtn").click(function(){
            	...
            	$.ajax({
            		...
            		beforeSend:function(){
            			loadingIndex = layer.msg('正在修改许可数据,请稍后！', {icon: 16});
            			return true ;
            		},
